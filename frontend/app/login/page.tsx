  ...
  return (
    ...
    >
      <path
        ...
        strokeWidth="1.4"
      />
      <path d="M2.5 5.5l7.5 5.5 7.5-5.5" stroke="currentColor" strokeWidth="1.4" />
    </svg>
  );
}
...
function IconLock() {
  return (
    <svg
      ...
      fill="none"
    >
      <rect x="4" y="8" width="12" height="9" rx="1.5" stroke="currentColor" strokeWidth="1.4" />
      <path d="M7 8V6a3 3 0 016 0v2" stroke="currentColor" strokeWidth="1.4" />
  ...
  return (
    <>
      ...
      <div className="min-h-screen flex flex-col font-dm" style={{ backgroundColor: "#f0ede8" }}>
        ...
        {/* ── Main ────────────────────────────────────────── */}
        <main className="flex-1 grid grid-cols-1 lg:grid-cols-2 items-center gap-10 max-w-6xl w-full mx-auto px-6 md:px-12 py-14">
