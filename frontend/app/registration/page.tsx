...
export default function SignupPage() {
  return (
    <div className="min-h-screen flex flex-col" style={{ background: 'linear-gradient(135deg, #f5f5f0 0%, #eef2ec 50%, #f0f5f0 100%)' }}>
      {/* Main Content */}
      <div className="flex flex-1">
        ...
        <div className="hidden lg:flex flex-col justify-between w-1/2 p-12 xl:p-16">
          ...
          <div className="space-y-8">
            <h1 className="text-5xl xl:text-6xl font-black text-gray-900 leading-tight">
              Engineered for{' '}
              <span style={{ color: '#b8860b' }}>Elite</span>{' '}
              Performance.
            </h1>
        ...
        <div className="flex lg:w-1/2 items-center justify-center p-6 lg:p-12">
          <div className="w-full bg-white rounded-2xl px-8 md:px-10 py-10 animate-fade-up">
            {/* Mobile logo */}
            ...
            {/* Form Header */}
            <div className="mb-8">
              <h2 className="text-[1.85rem] font-bold tracking-tight text-gray-900 mb-1.5">Create Account</h2>
              <p className="text-gray-400 text-sm mt-1">Ready to elevate your riding experience?</p>
            </div>
            ...
            <form className="space-y-5">
              ...
              <div>
                ...
                <input
                  type="text"
                  placeholder="Velofit"
                  className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-gray-800 placeholder-gray-400 focus:outline-none focus:border-amber-400 focus:ring-2 focus:ring-amber-100 transition-all"
                />
              </div>
              ...
              <button
                type="submit"
                className="w-full py-3.5 text-white font-bold rounded-2xl transition-all duration-200 hover:opacity-90 hover:shadow-lg flex items-center justify-center gap-2 group"
                style={{
