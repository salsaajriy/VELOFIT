...
export default function DashboardPage() {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-gray-50">
      ...
      {/* Main Content - tanpa lg:ml-52 dan dengan padding-top untuk navbar */}
              ...
              <div className="inline-flex items-center gap-2 mb-3">
                {weatherLoading ? (
                  ...
                  <>
                    ...
                    <span className="text-orange-500">{weather.condition}</span>
                  </>
                ) : (
                  <span>No weather</span>
                )}
              </div>
              <h2 className="text-2xl font-black text-orange-500 leading-tight mb-5">
                {weatherTheme.title}
              </h2>
              <p className="text-gray-800 mb-6">{weatherTheme.subtitle}</p>
      ...
      {/* Footer di luar main, di paling bawah */}
      <Footer />
