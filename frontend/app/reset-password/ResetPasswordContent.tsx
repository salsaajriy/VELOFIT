...
export default function ResetPasswordContent() {
  ...
  useEffect(() => {
    if (!email || !token) {
      setError(
        "The password reset link is not valid. Please request a new link.",
      );
    }
  }, [email, token]);
      ...
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          <div className="m-6 relative inline-block">
            ...
            <div
              className="relative w-20 h-20 mx-auto rounded-2xl rotate-45 flex items-center justify-center shadow-lg"
              style={{
            ...
            >
              ...
              <svg
                className="relative w-10 h-10 text-orange-500 -rotate-45"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
            ...
            <div className="bg-gray-50 rounded-md p-3">
              ...
              <ul className="text-xs text-gray-500 space-y-1">
                <li className="flex items-center">
                  <span
                    className={`inline-block w-4 h-4 rounded-full mr-2 ${password.length >= 8 ? "bg-green-500" : "bg-gray-300"}`}
                  >
                    {password.length >= 8 && (
                      <svg
                ...
                <li className="flex items-center">
                  <span
                    className={`inline-block w-4 h-4 rounded-full mr-2 ${/[A-Z]/.test(password) ? "bg-green-500" : "bg-gray-300"}`}
                  >
                    {/[A-Z]/.test(password) && (
                      <svg
                        className="w-4 h-4 text-white"
                ...
                <li className="flex items-center">
                  <span
                    className={`inline-block w-4 h-4 rounded-full mr-2 ${/[0-9]/.test(password) ? "bg-green-500" : "bg-gray-300"}`}
                  >
                    {/[0-9]/.test(password) && (
                      <svg
                        className="w-4 h-4 text-white"
